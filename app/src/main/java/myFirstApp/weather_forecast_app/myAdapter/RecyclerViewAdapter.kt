package myFirstApp.weather_forecast_app.myAdapter
...
import myFirstApp.weather_forecast_app.utils.IconMap.weatherIconsDetector
...
class RecyclerViewAdapter: RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.info5.text = myList[position].wind
        holder.itemView.info6.text = myList[position].humidity
    }
