...
import myFirstApp.weather_forecast_app.databinding.FragmentZaoBinding
...
class ZaoFragment : Fragment() {
    ...
    private lateinit var binding: FragmentZaoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentZaoBinding.inflate(inflater, container, false)
        binding.vm = viewModel
        binding.lifecycleOwner = this

        viewModel.pushPost(Post("zao"))
